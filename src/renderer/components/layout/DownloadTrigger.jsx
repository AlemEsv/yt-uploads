    ...
    <div ref={panelRef} className="relative">
      ...
      {open && (
        <form
          ...
          className="popover-in absolute top-full right-0 mt-2 w-[340px] p-3 rounded-[12px] border border-[var(--color-overlay-border)] glass shadow-2xl flex gap-2 z-[2000]"
        >
          <input
            type="text"
            autoFocus
            ...
            className="flex-1 px-3 py-2 rounded-[8px] border border-[var(--color-overlay-border)] bg-[var(--color-overlay-subtle)] text-[var(--color-text-primary)] text-[13px] outline-none focus:ring-1 focus:ring-[var(--color-accent)]"
          />
          <button
            type="submit"
