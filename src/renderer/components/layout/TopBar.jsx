    ...
    <header className="flex items-center gap-4 px-6 py-3 shrink-0 z-10">
      ...
      <div className="flex-1 max-w-[600px]">
        <div className="relative">
          <Search
            size={14}
            className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--color-search-placeholder)]"
          />
          <input
            type="text"
            value={searchQuery}
            ...
            className="w-full bg-[var(--color-search-bg)] text-[var(--color-search-text)] placeholder:text-[var(--color-search-placeholder)] placeholder:italic placeholder:text-[12px] rounded-[6px] h-[34px] pl-8 pr-4 text-[13px] outline-none focus:ring-1 focus:ring-[var(--color-accent)]"
          />
        </div>
      </div>
